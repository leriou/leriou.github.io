---
title: "给团队成员的Redis分享总结"
published: 2017-10-29
category: "分布式存储"
tags: 
  - "redis"
  - "NoSQL"
description: "Author: leriou lee 2017.10.12 本篇内容主要是针对团队成员的redis中间件分享"
---
...
![redis.png](https://i.loli.net/2020/05/09/BKtdElZifANIg8c.png)
...
- keepalived(基于VRRP协议)
- 哨兵(sentinal)
- 集群(cluster): redis3.0之后提供，同时也是个人比较建议的方案
- 其他第三方方案
...
2. 使用`cluster nodes` 命令检查集群节点的状态
...
![IMG_0255.jpeg](https://i.loli.net/2020/05/09/deSBNkvgwpaE2tK.jpg)

**数据对象和底层实现的数据结构对应关系**

Redis数据对象的内部复杂实现，其实是针对2个不同场景， 省内存和常规使用
...
![flow1.png](https://i.loli.net/2020/05/09/xpNhU9XPYFn4OcA.png)
